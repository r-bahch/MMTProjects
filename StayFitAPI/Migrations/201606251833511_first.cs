    ...
    public partial class first : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        VideoUrl = c.String(),
                        MuscleGroup_ID = c.Int(),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.MuscleGroups", t => t.MuscleGroup_ID)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.ApplicationUserID, t.ExerciseID })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Schedules", "ExerciseID", "dbo.Exercises");
            ...
            DropIndex("dbo.Schedules", new[] { "ExerciseID" });
